...
**关联**：
- 落地依据：Proposal #12（跨 crate const 重复定义盲点；DEFAULT_HZ 案例），源规则见 [review-rules/review-doc-checklist.md §2.4g](../../../prompt/review-rules/review-doc-checklist.md)
...
> **模式参考**：[review-rules/review-process.md §Step 4.5 测试验证（Gate E）](../../../prompt/review-rules/review-process.md)。
