...
<example>
  ...
  assistant: "I'll run tools/design-coverage-check.sh to identify missing snapshots, then backfill {NN}-outline.v1.md / {NN}-design.v1.md following appendix C flow (独立推导，非复用其他 doc)"
</example>