...
- **Step 0 预检**: design + outline 完整性（**所有模式强制**，2026-07-16 扩）— 4 条 `ls design/{NN}-*.md` 必跑 → scan.md `§Step 0: 预检结果` 段必含（**模式 69 PSMD + 71 DOG 配套**）。详见 [process-skill §Step 0 硬阻断规则](review-process-skill.md)。
```
