...
| 79-83 | 九、架构抽象与锚点纪律模式（2026-09-05 新增） | trait 边界/YAGNI/mock 隔离/cfg 泄漏/锚点纪律 |
...
## 九、架构抽象与锚点纪律模式（2026-09-05 新增）

> 本节前 4 条来自 05-clock-interrupt-init.md §4.7.1 重构 `ArchBoot::register_timer_handler` 时归纳的四条元原则，第 5 条（模式 83）来自多轮 review 沉淀的锚点纪律。反例细节保留在源文档，本节只给判据与验证命令。
