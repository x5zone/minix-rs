# 23-cross-space-runtime: 跨地址空间运行时
...
- [17-syscall-copy.md](17-syscall-copy.md) — vircopy/safecopy 底层实现
- [18-syscall-signal.md](18-syscall-signal.md) — SIGSEND 使用 data_copy_vmcheck
