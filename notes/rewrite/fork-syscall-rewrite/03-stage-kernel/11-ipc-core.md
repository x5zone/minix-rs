...
- [10-scheduling-primitives](10-scheduling-primitives.md) — RTS_SENDING/RECEIVING 对调度的影响
- [09-switch-to-user](09-switch-to-user.md) — delivermsg 在 misc 标志处理中调用
- [12-syscall-dispatch](12-syscall-dispatch.md) — do_ipc 的分派路径
- [13-exception-interrupt](13-exception-interrupt.md) — 中断通过 mini_notify 唤醒进程
