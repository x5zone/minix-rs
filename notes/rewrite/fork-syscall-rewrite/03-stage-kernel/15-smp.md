...
> **前置**: 10-scheduling-primitives.md
> **创建**: 2026-06-13
...
- [10-scheduling-primitives.md](10-scheduling-primitives.md) — per-CPU 调度队列
- [14-clock-timer.md](14-clock-timer.md) — BSP/AP 时钟中断差异
- [21-privilege.md](21-privilege.md) — VMINHIBIT 与权限
