# 10-scheduling-primitives: 调度原语与进程状态机
...
- [09-switch-to-user](09-switch-to-user.md) — 调用 enqueue/dequeue/pick_proc
- [08-vm-boot-protocol](08-vm-boot-protocol.md) — VMINHIBIT 对调度的影响
- [11-ipc-core](11-ipc-core.md) — SENDING/RECEIVING 对调度的影响
