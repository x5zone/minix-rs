...
设计决策 D9（07-system-init）：这些调用在非 x86 架构上返回 `KcallResult::BadCall`。
...
- [13-exception-interrupt.md](13-exception-interrupt.md) — IRQ hook 注册/分发
- [21-privilege.md](21-privilege.md) — CHECK_IO_PORT / CHECK_IRQ 权限
