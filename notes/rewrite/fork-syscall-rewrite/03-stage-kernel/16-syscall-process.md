...
> **前置**: 10-scheduling-primitives.md, 15-smp.md
> **创建**: 2026-06-13
...
- [10-scheduling-primitives.md](10-scheduling-primitives.md) — sched_proc()
- [15-smp.md](15-smp.md) — 跨 CPU 停止进程
- [18-syscall-signal.md](18-syscall-signal.md) — cause_sig()
- [21-privilege.md](21-privilege.md) — 权限降级
