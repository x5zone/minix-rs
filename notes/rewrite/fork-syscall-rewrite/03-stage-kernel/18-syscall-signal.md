...
- [10-scheduling-primitives.md](10-scheduling-primitives.md) — RTS_SIGNALED/RTS_SIG_PENDING 定义
- [13-exception-interrupt.md](13-exception-interrupt.md) — exception_handler 调用 cause_sig
- [14-clock-timer.md](14-clock-timer.md) — vtimer_check 发送 SIGVTALRM/SIGPROF
